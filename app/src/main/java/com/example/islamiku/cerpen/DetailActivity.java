...
import com.example.islamiku.cerpen.MainAdapter;
...
public class DetailActivity extends AppCompatActivity {
    ...
    ModelCerpen mdlDetail;
    String dtlName, dtlThn, dtlUsia, dtlDesc, dtlTmp;
    TextView tvThn, tvUsia, tvDesc, tvTtl;
    Toolbar tbDetail;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mdlDetail = (ModelCerpen) getIntent().getSerializableExtra("paramDtl");
        ...
        if (mdlDetail != null) {
            ...
            tvTtl = findViewById(R.id.tmp);
            tvTtl.setText(dtlTmp);
